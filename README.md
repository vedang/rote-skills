...
3. **Menu-driven setup** — install adapters à la carte from the live registry, wire
   credentials, connect Google OAuth, install the agent skill, and explore — you pick what
   runs.
